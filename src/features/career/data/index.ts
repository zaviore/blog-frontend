...
export const careerData: CareerExperience[] = [
  {
    ...
    techStack: ['Laravel', 'MySQL', 'HTML', 'Bootstrap', 'jQuery', 'Docker', 'PHP', 'Blade'],
    jobDetails: [
  ...
  },
  {
    ...
    jobDetails: [
      'Built company profile websites backed by CMS workflows',
      'Created REST API endpoints for custom application needs',
      'Designed and developed portfolio websites for personal and business use cases',
      'Maintained dashboards by improving existing features and customization flows',
      'Built admin dashboard interfaces for operational data management',
    ],
  },
]
